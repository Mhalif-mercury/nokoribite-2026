...
class PickupPolicy
{
    ...
    {
        return $user->can('view_any_pickup');
    }
    ...
    {
        return $user->can('delete_any_pickup');
    }
     ...
     */
    public function replicate(User $user, Pickup $pickup): bool
    {
