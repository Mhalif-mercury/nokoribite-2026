...
class DiscountRulePolicy
{
    ...
    {
        return $user->can('view_any_discount::rule');
    }
    ...
    {
        return $user->can('view_discount::rule');
    }
    ...
    {
        return $user->can('create_discount::rule');
    }
    ...
    {
        return $user->can('update_discount::rule');
    }
    ...
    {
        return $user->can('delete_discount::rule');
    }
    ...
    {
        return $user->can('delete_any_discount::rule');
    }
     ...
     */
    public function replicate(User $user, DiscountRule $discountRule): bool
    {
